...
First, make sure you check the answer key for Exercise 11 on iCollege—the [complete code](https://andrewheiss.quarto.pub/datavizf25_11-exercise-answers/dashboard-code.html) for the dashboard that you had to recreate is there.
