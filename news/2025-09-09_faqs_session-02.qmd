...
This is a tricky quirk of using Quarto. In Markdown, the `#` symbol is how you [create headings](/news/2025-09-06_cleaner-nicer-qmd-output.qmd#headings-that-aren't-headings), and you can combine them to create nested headings and subheadings:
...
In general you'll want to use all four at the same time. Remember this slide from the lecture?
