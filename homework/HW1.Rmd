...
In this homework, we'll adapt data from Chicago-IL communities. The original source is the [GeoDa Data and Lab](https://geodacenter.github.io/data-and-lab/). The first dataset [Airbnb.RDS](/files/data/urban-econ/airbnb.RDS) refers to Airbnb rentals, socioeconomic indicators, and crime by community area in Chicago. The [Communities.xls](/files/data/urban-econ/communities.xls) dataset contains health and socioeconomic indicators for the 77 community areas of Chicago, 2012-2014. 
