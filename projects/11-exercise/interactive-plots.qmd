...
Use `ggplot()` and `ggplotly()` to recreate [the interactive plot from the instructions website](https://andrewheiss.quarto.pub/datavizf25_11-exercise-recreate/interactive-plots.html).
