---
title: "Lab 4: Mapping data with tmap"
...
Make sure all the necessary data files are in your working directory. You need to `require()` all the packages you need to perform the task. If it is the first time you are using them, you need to `install.packages()` first.
