---
title: "Lab 3: Intro to Tidycensus"
author: "Hussain Hadah"
date: "2/25/2021"
abstract: "Introduction to using the tidycensus package for accessing US Census data."
execute:
  eval: false
---
...
Tidycensus is an R package that allows for interfacing with the US Census Bureau's data. Using the function `get_decennial()`, you have access to the 2000 and 2010 decennial US Census, and using `get_acs()`, you can get data from the 1-year and 5-year American Community Survey.  
